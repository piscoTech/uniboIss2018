	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		{/* JavaLikeMove */ 
	    		it.unibo.robot.mbotConnTcp.mbotStop(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		//end arg1
	    		it.unibo.robot.mbotConnTcp.mbotForward(this,arg1 );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		arg1 =  updateVars( Term.createTerm("moveRobot(X)"), Term.createTerm("moveRobot(s(X))"), 
	    			                Term.createTerm(currentMessage.msgContent()),  arg1 );	                
	    		//end arg1
	    		it.unibo.robot.mbotConnTcp.mbotBackward(this,arg1 );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.robot.mbotConnTcp.mbotLeft(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.robot.mbotConnTcp.mbotRight(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
