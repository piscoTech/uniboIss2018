%==============================================
% WorldTheory.pl for actor lampadapter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatulampadapter).	%%old version (deprecated)
actorobj(qatulampadapter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor lampadapter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of lampadapter" ). 
